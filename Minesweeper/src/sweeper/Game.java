...
public class Game
{
    ...
    private void openBox(Coord coord)
    {
        ...
        {
            case OPENED: setOpenToCloseBoxesAroundNumber(coord); break;
            case FLAGED:break;
            case CLOSED:
    ...
    private void setOpenToCloseBoxesAroundNumber(Coord coord)
    {
        if (Box.BOMB != bomb.get(coord))
            if(bomb.get(coord).getNumber()==flag.getCountOfFlagedBosexAround(coord))
